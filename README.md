# Edu project for "React 16 For Everyone" course by Level Up Tutorials (Scott Tolinski)

All project settings are initially created by the "create-react-app" npm module.
